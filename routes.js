...
function drawRoute(idx) {
  ...
  gLy = L.polyline(coords, {color: "#0a1428", weight: 10, opacity: 0.6, lineCap: "round", lineJoin: "round", className: "route-fade-in"}).addTo(map);
  ...
  for (var si = 0; si < coords.length - 1; si += segSize) {
    ...
    L.polyline(seg, {color: "rgb(" + r2 + "," + g2 + "," + b2 + ")", weight: 5, opacity: 0.95, lineCap: "round", lineJoin: "round", className: "route-fade-in"}).addTo(segGroup);
  }
  rLy = segGroup;
