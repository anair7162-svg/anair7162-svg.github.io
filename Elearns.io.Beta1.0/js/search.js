...
function clr() {
  [rLy, gLy, rCir, pMk, drvLy, rtStartMk, rtEndMk].forEach(function(l) { if (l) map.removeLayer(l); });
  rLy = gLy = rCir = pMk = drvLy = rtStartMk = rtEndMk = null;
